...
import com.sarthak.order.model.PurchaseRequest;
import com.sarthak.order.model.PurchaseResponse;
...
public class ProductClient {
    ...
    public List<PurchaseResponse> purchaseProduct(List<PurchaseRequest> request){
        ...
        if(responseEntity.getStatusCode().isError()){
            throw new BusinessException("An error occurred while purchasing the product");
        }
